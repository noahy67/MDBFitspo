...
class StorageManager {
    ...
    public func uploadWardrobePicture(with image: UIImage, fileName: String, completion: @escaping UploadPictureCompletion) {
        
        let storageRef = storage.reference()
        
        let postPicRef = storageRef.child("wardrobePics/\(fileName)_wardrobe_picture.jpg")
